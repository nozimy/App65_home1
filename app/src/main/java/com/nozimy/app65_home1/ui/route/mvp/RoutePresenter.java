...
//    LatLng origin = new LatLng(56.837818,53.228243);
//    LatLng destination = new LatLng(56.870908,53.179052);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(contactA != null
            ...
            routeInteractor.getRoute( contactA.getLat()+","+contactA.getLng(),  contactB.getLat()+","+contactB.getLng())
    ...
    void showRoute(RouteResponse routeResponse, ContactEntity originContact, ContactEntity destinationContact){
        ...
        mMap.addMarker(new MarkerOptions().position(origin).title(originContact.getDisplayName()).snippet(originContact.getAddress()));
        mMap.addMarker(new MarkerOptions().position(destination).title(destinationContact.getDisplayName()).snippet(destinationContact.getAddress()));
