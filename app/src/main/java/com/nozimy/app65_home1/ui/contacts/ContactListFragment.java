...
public class ContactListFragment extends Fragment implements ContactClickCallback, ContactListContract.View {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("List FRAGMENT", "onActivityCreated");
...
//        contactListViewModel = ViewModelProviders.of(this).get(ContactListViewModel.class);
        ...
        if(!checkSelfPermission()){
            requestPermissions(new String[]{Manifest.permission.READ_CONTACTS}, ContactListPresenter.REQUEST_CODE_READ_CONTACTS);
        }
