...
public class ContactPresenter<V extends ContactDetailsContract.View> extends BasePresenter<V> implements ContactDetailsContract.Presenter<V> {
...
//    private final Flowable<List<EmailEntity>> observableEmails;
    ...
    public ContactPresenter(ContactInteractor contactInteractor, CompositeDisposable compositeDisposable) {
...
//    }
    ...
    private void showContact(ContactEntity contactEntity, List<PhoneEntity> phoneEntities, List<EmailEntity> emailEntities){
